...
object AchievementSeedData {
    ...
    fun create(): List<AchievementDefinitionEntity> = listOf(
        ...
        AchievementDefinitionEntity("explore_tower", "登高望遠", "登上觀景台", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 30),
        AchievementDefinitionEntity("explore_tokyo_tower", "東京鐵塔", "參訪東京鐵塔", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("explore_great_wall", "萬里長城", "親眼目睹長城", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 200),
        AchievementDefinitionEntity("explore_venice", "水都之旅", "造訪威尼斯", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 150),
        // Seven oceans (hidden)
        ...
        AchievementDefinitionEntity("career_raise", "談判大師", "成功爭取加薪", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("career_quit", "華麗轉身", "裸辭一次", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 75),
        AchievementDefinitionEntity("career_meeting_hell", "會議地獄", "一天開 5 場會", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 30),
        ...
        AchievementDefinitionEntity("daily_umbrella", "雨傘收藏家", "弄丟一把雨傘", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 10),
        AchievementDefinitionEntity("daily_late", "時間旅人", "遲到超過 30 分鐘", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 20),
        AchievementDefinitionEntity("daily_spicy", "地獄級挑戰", "吃完一碗麻辣鍋", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 30),
        AchievementDefinitionEntity("daily_karaoke", "浴室歌王", "在 KTV 唱完一首歌", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 20),
        AchievementDefinitionEntity("daily_fall_down", "仆街達人", "在公共場合跌倒", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 15),
        // Manual confirm - epic
        ...
        AchievementDefinitionEntity("epic_first_date", "初戀滋味", "完成第一次約會", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("epic_concert", "現場實況", "參加一場大型演唱會", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 150),
        ...
        AchievementDefinitionEntity("health_pushup_50", "伏地挺身", "一次完成 50 個伏地挺身", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 50),
        AchievementDefinitionEntity("health_weight_loss", "瘦身有成", "成功減重 10 公斤", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 200),
        AchievementDefinitionEntity("health_sleep_8h", "睡飽飽", "連續一週睡眠滿 8 小時", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        ...
        AchievementDefinitionEntity("transport_uber_100", "叫車之王", "搭乘 100 次叫車服務", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("transport_bike_100", "單車百公里", "累積騎行 100 公里", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 150),
        AchievementDefinitionEntity("health_yoga", "瑜伽修行", "完成一堂瑜伽課", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 30),
        AchievementDefinitionEntity("health_vegan", "素食挑戰", "連續一個月素食", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("health_plank_5min", "核心之王", "平板支撐超過 5 分鐘", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("daily_look_up", "仰望星空", "抬頭看星星超過 10 分鐘", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 20),
        AchievementDefinitionEntity("daily_suntan", "曬黑一族", "在海灘曬傷", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 15),
        AchievementDefinitionEntity("daily_chopsticks", "筷子達人", "用筷子夾起豆腐不碎", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 50),
        AchievementDefinitionEntity("career_overtime_hell", "加班地獄", "連續一個月每天加班 3 小時", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 50),
        AchievementDefinitionEntity("career_presentation", "簡報之王", "在超過 50 人面前簡報", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("explore_bucket_list", "心願達成", "完成一件人生願望清單", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 300),
        AchievementDefinitionEntity("explore_sky_lantern", "天燈祈願", "親手放天燈", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 50),
        AchievementDefinitionEntity("explore_snow", "初見雪景", "第一次看到雪", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 50),
        AchievementDefinitionEntity("explore_desert", "沙漠足跡", "踏上沙漠", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 150),
        AchievementDefinitionEntity("explore_jungle", "叢林冒險", "深入熱帶雨林", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 200),
        AchievementDefinitionEntity("explore_underwater", "海底世界", "潛水探索海洋", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 200),
        AchievementDefinitionEntity("explore_camping", "星空露營", "完成一次野外露營", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 75),
        AchievementDefinitionEntity("daily_diy", "手作達人", "自己動手 DIY 一件物品", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 30),
        AchievementDefinitionEntity("daily_fix", "修理之王", "自己修理家電", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 50),
        AchievementDefinitionEntity("daily_plant", "綠手指", "成功養活一盆植物超過一年", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("daily_tattoo", "身體藝術", "完成第一個刺青", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, false, 100),
        AchievementDefinitionEntity("daily_photo_album", "回憶收集者", "整理一本實體相簿", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, false, 50),
    )
