...
object AchievementSeedData {
    ...
    fun create(): List<AchievementDefinitionEntity> = listOf(
        // Location check-in achievements
        ...
        AchievementDefinitionEntity("checkin_3", "三度到訪", "在 3 個不同地點打卡", "ic_achievement_photo_2", TriggerType.LOCATION_CHECKIN_COUNT.value, 3L, false, 15),
        ...
        AchievementDefinitionEntity("checkin_10", "十全打卡", "在 10 個不同地點打卡", "ic_achievement_photo_1", TriggerType.LOCATION_CHECKIN_COUNT.value, 10L, false, 50),
        ...
        AchievementDefinitionEntity("checkin_50", "打卡之王", "在 50 個不同地點打卡", "ic_achievement_photo_3", TriggerType.LOCATION_CHECKIN_COUNT.value, 50L, false, 200),
        ...
        // Seven oceans (hidden)
        AchievementDefinitionEntity("ocean_pacific", "太平洋", "造訪太平洋沿岸", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, true, 200, "東亞、美洲西岸的海域"),
        AchievementDefinitionEntity("ocean_atlantic", "大西洋", "造訪大西洋沿岸", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, true, 200, "歐洲、非洲西岸的海域"),
        AchievementDefinitionEntity("ocean_indian", "印度洋", "造訪印度洋沿岸", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, true, 200, "南亞、東非沿海的海域"),
        AchievementDefinitionEntity("ocean_arctic", "北冰洋", "造訪北冰洋沿岸", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, true, 500, "極北之地的冰冷海域"),
        AchievementDefinitionEntity("ocean_southern", "南冰洋", "造訪南冰洋沿岸", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, true, 500, "環繞南極洲的極寒海域"),
        // Manual confirm - career
        ...
        // Manual confirm - epic
        AchievementDefinitionEntity("epic_eclipse", "日月蝕", "親眼目睹日蝕或月蝕", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, true, 200, "天空中的光影奇觀"),
        AchievementDefinitionEntity("epic_survive", "死裡逃生", "經歷一次生死關頭", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, true, 500, "從最危險的處境中活下來"),
        AchievementDefinitionEntity("epic_newborn", "新生命", "迎接新生兒", "ic_achievement_photo_2", TriggerType.MANUAL_CONFIRM.value, 1L, true, 500, "一個小小的生命來到這個世界"),
        AchievementDefinitionEntity("epic_northernlights", "極光奇景", "親眼目睹極光", "ic_achievement_photo_3", TriggerType.MANUAL_CONFIRM.value, 1L, true, 500, "高緯度地區的夢幻光幕"),
        AchievementDefinitionEntity("epic_milkyway", "銀河之旅", "親眼看見銀河", "ic_achievement_photo_1", TriggerType.MANUAL_CONFIRM.value, 1L, true, 300, "遠離光害的星空奇景"),
